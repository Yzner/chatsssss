    ...
    <div>
      ...
      <section className="welcome-section">
        <div className="welcome-text">
          <h1 className="college-title">ADDING</h1>
        </div>
      </section>
      ...
      <div className="shifting-steps">
        ...
        <div class="step-box">
          <div class="step-header">
              <span class="step-number">02.</span> Adding of subject/s
          </div>
          <div class="step-content">
              <span class="bullet">✳</span> The student shall select the courses they need to drop then click submit.
              <p>Note: The student is required to explain their reason for adding of their subject/s</p>
          </div>
        </div>
        ...
        <div class="step-box">
          ...
          <div class="step-content">
              <span class="bullet">✳</span> The program chairperson shall review the submitted requests for adding of subjects and once confirmed they will click the “recommending approval” button. If disapproved, they shall click the “disapproved” button then click “send email” and type in the reason.
          </div>
        </div>
        ...
        <div class="step-box">
          ...
          <div class="step-content">
              <span class="bullet">✳</span> Once the request for adding of subjects has been recommended by the program chairperson, the associate dean shall check and click the approved/disapproved button.
          </div>
        </div>
        ...
        <div class="step-box">
          ...
          <div class="step-content">
              <span class="bullet">✳</span> The student shall proceed to the Cashier’s Office for payment of their adding of subjects.
          </div>
        </div>
